...
Git Clone https://github.com/cookieo0050/WinX_engine_beta.git

Go to the folder and click the .slnx file and run there may be errors when starting up but to fix most you will have to redo the properties for Glm, GLFW, Imgui.
